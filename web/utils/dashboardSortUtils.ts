import { BorrowAssetsItem } from 'modules/dashboard/lists/BorrowAssetsList/types';
import { SupplyAssetsItem } from 'modules/dashboard/lists/SupplyAssetsList/types';
import { InterestRate } from 'protocol/aave-compat';
