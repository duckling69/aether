...
import type { FormattedReserveHistoryItem } from './ApyGraph';

const ApyGraph = dynamic(() => import('./ApyGraph').then((m) => m.ApyGraph), {
  ssr: false,
  loading: () => null,
});
const PlaceholderChart = dynamic(
  () => import('./ApyGraph').then((m) => m.PlaceholderChart),
