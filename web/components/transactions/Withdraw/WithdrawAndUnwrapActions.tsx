...
import { useApprovedAmount } from 'hooks/useApprovedAmount';
import { useModalContext } from 'hooks/useModal';
import { useWeb3Context } from 'libs/hooks/useWeb3Context';
import { gasLimitRecommendations, ProtocolAction, valueToWei } from 'protocol/aave-compat';
  ...
  const action = async () => {
    try {
      ...
      if (usePermit && signatureParams) {
        let signedTxData: any = await tokenWrapperService.withdrawWrappedTokenWithPermit(
          convertedAmount,
          tokenWrapperAddress,
          user,
        ...
        let txData: any = await tokenWrapperService.withdrawWrappedToken(
          convertedAmount,
          tokenWrapperAddress,
          account
        );
