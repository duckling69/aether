...
import { calculateSignedAmount } from 'hooks/paraswap/common';
import { useGetConnectedWalletType } from 'hooks/useGetConnectedWalletType';
...
import { isPermitSupportedWithFallback } from 'ui-config/permitConfig';
import { getProvider } from 'utils/marketsAndNetworksConfig';
import { needsUSDTApprovalReset } from 'utils/usdtHelpers';
