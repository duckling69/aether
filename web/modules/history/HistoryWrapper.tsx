...
import { TRANSACTION_HISTORY } from 'utils/events';
...
export const HistoryWrapper = () => {
  ...
  const handleCsvDownload = async () => {
    ...
    const formattedData = formatTransactionData({ data, csv: true }) as unknown as TransactionHistoryItemUnion[];
    ...
    >
      ...
      >
        {isFetchingNextPage && (
          ...
          >
            <CircularProgress size={20} style={{ color: '#1A1A1A' }} />
          </Box>
        )}
      </Box>
    </ListWrapper>
